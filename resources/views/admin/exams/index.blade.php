                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if (auth()->user()->hasPermission('create_exams'))
                                        <a href="{{ route('admin.exams.create') }}" wire:navigate class="btn btn-primary"><i data-feather="plus"></i> @lang('site.create')</a>
                                    @endif

                                    @if (auth()->user()->hasPermission('delete_exams'))
                                        <form method="post" action="{{ route('admin.exams.bulk_delete') }}" class="ajax-form" style="display: inline-block;">
                                            @csrf
                                            @method('delete')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table datatable" id="exams-table" style="width: 100%;">
                                            <thead>
                                            <tr>
                                                <th>
...
@push('scripts')
    ...
    <script>
        ...
        $(function () {
            ...
            let examsTable = $('#exams-table').DataTable({
                dom: "tiplr",
                buttons: [
                    {
                        extend: 'excelHtml5',
