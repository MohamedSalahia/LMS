                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if (auth()->user()->hasPermission('create_books'))
                                        <a href="{{ route('admin.books.create') }}" wire:navigate class="btn btn-primary"><i data-feather="plus"></i> @lang('site.create')</a>
                                    @endif

                                    @if (auth()->user()->hasPermission('delete_books'))
                                        <form method="post" action="{{ route('admin.books.bulk_delete') }}" class="ajax-form" style="display: inline-block;">
                                            @csrf
                                            @method('delete')
