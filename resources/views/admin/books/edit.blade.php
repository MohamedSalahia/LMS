                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.books.update', $book->id) }}" class="ajax-form">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{ $book->name }}" autofocus required>
                                </div>

                                {{--number_of_pages--}}
                                <div class="form-group">
                                    <label>@lang('books.number_of_pages') <span class="text-danger">*</span></label>
                                    <input type="text" name="number_of_pages" class="form-control" value="{{ old('number_of_pages', $book->number_of_pages) }}" required>
                                </div>
