                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.countries.index') }}">@lang('countries.countries')</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.countries.update', $country->id) }}" class="ajax-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{ $country->name }}" autofocus required>
                                </div>
