                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.sections.index') }}">@lang('sections.sections')</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.sections.update', $section->id) }}" class="ajax-form">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="center_id" id="center-id" class="form-control select2" required>
                                        <option value="">@lang('site.choose') @lang('centers.center')</option>
                                        @foreach ($centers as $center)
                                            <option value="{{ $center->id }}"
                                                    {{ $center->id == $section->center_id ? 'selected' : '' }}
