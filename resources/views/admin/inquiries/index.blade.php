                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if (auth()->user()->hasPermission('delete_inquiries'))
                                        <form method="post" action="{{ route('admin.inquiries.bulk_delete') }}" style="display: inline-block;">
                                            @csrf
                                            @method('delete')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table datatable" id="inquiries-table" style="width: 100%;">
                                            <thead>
                                            <tr>
                                                <th>
