                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="first_name" class="form-control" autofocus value="{{ $admin->first_name }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="second_name" class="form-control" autofocus value="{{ $admin->second_name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nickname" class="form-control" value="{{ old('nickname', $admin->nickname) }}" required>
                                        </div>
                                    </div>
