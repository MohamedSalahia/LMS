                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.centers.index') }}" wire:navigate>@lang('centers.centers')</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.centers.store') }}" class="ajax-form">
                                @csrf
                                @method('post')
