                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">@lang('courses.courses')</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if (auth()->user()->hasPermission('create_courses'))
                                        <a href="{{ route('admin.courses.create') }}" wire:navigate class="btn btn-primary"><i data-feather="plus"></i> @lang('site.create')</a>
                                    @endif
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table datatable" id="courses-table" style="width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <th>@lang('courses.image')</th>
                                                <th>@lang('courses.title')</th>
                                                <th>@lang('courses.short_description')</th>
        ...
        $(function () {
            ...
            let coursesTable = $('#courses-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'short_description', name: 'short_description', searchable: false},
