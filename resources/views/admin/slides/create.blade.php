                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.slides.store') }}" class="ajax-form">
                                @csrf
                                @method('post')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="upper_title" class="form-control" value="{{ old('upper_title') }}" required autofocus>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" name="link" class="form-control" value="{{ old('url') }}" required>
                                </div>
