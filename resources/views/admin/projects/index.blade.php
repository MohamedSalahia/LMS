                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if (auth()->user()->hasPermission('create_projects'))
                                        <a href="{{ route('admin.projects.create') }}" wire:navigate class="btn btn-primary"><i data-feather="plus"></i> @lang('site.create')</a>
                                    @endif

                                    @if (auth()->user()->hasPermission('delete_projects'))
                                        <form method="post" action="{{ route('admin.projects.bulk_delete') }}" class="ajax-form" style="display: inline-block;">
                                            @csrf
                                            @method('delete')
        ...
        $(function () {
            ...
            let projectsTable = $('#projects-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'name', name: 'name'},
                    {data: 'centers', name: 'centers', searchable: false, sortable: false},
