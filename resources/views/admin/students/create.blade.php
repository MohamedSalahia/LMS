                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.students.index') }}"
                                                               wire:navigate>@lang('students.students')</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.students.store') }}" class="ajax-form">
                                @csrf
                                @method('post')
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="" class="loaded-image" alt=""
                                         style="display: none; width: 100px; margin: 10px 0;">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="reading_type" class="form-control select2" required>
                                        ...
                                        @foreach (ReadingTypeEnum::getConstants() as $readingType)
                                            <option value="{{ $readingType }}">@lang('users.' . $readingType)</option>
                                        @endforeach
                                    </select>
                                </div>
