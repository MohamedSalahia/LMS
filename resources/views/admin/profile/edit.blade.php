                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="first_name" class="form-control" value="{{ old('name', auth()->user()->first_name) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('users.second_name')</label>
                                            <input type="text" name="second_name" class="form-control" value="{{ old('name', auth()->user()->second_name) }}" required>
                                        </div>
                                    </div>
